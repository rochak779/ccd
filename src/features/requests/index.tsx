...
export function RequestTracker({ requests = NORTHSTAR_REQUESTS, title = "Northstar request tracker", recordLabel = "actual records" }: { requests?: TrackerRequest[]; title?: string; recordLabel?: string }) {
  ...
  return <section className="feature-stack" aria-labelledby="requests-title"><header><p>Requests</p><h2 id="requests-title">{title}</h2><p>{requests.length} {recordLabel}</p></header>
